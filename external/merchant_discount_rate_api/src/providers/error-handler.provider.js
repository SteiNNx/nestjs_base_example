 ...
 * De lo contrario, se crea y pasa un nuevo TechnicalError con el código y mensaje por defecto.
 *
 ...
 * @param {string} defaultErrorHttpStatusCode - Mensaje de error por defecto para error desconocido.
 */
 ...
 * Si el error es una instancia de alguno de los errores conocidos, se lanza directamente.
 * De lo contrario, se crea y lanza un nuevo TechnicalError con el código y mensaje por defecto.
 *
 ...
 * @param {string} defaultErrorMessage - Mensaje de error por defecto para error desconocido.
 * @param {string} defaultErrorHttpStatusCode - Mensaje de error por defecto para error desconocido.
 * @throws {Error} El mismo error si es conocido o un nuevo TechnicalError si es desconocido.
 */
