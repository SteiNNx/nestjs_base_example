...
class MdrMastercardRepository {
  ...
  async getByMcc(mcc) {
    try {
      ...
      logger.error(`Error en MdrMastercardRepository.getByMcc: ${error.message}`, error);
      throw error;
    }
  }
  ...
  async add(record) {
    try {
      ...
      logger.error(`Error en MdrMastercardRepository.add: ${error.message}`, error);
      throw error;
    }
  }
  ...
  async update(mcc, field, newValue) {
    try {
      ...
      logger.error(`Error en MdrMastercardRepository.update: ${error.message}`, error);
      throw error;
    }
  }
  ...
  async delete(mcc) {
    try {
      ...
      logger.error(`Error en MdrMastercardRepository.delete: ${error.message}`, error);
      throw error;
    }
  }
  ...
  async scan() {
    try {
      ...
      logger.error(`Error en MdrMastercardRepository.scan: ${error.message}`, error);
      throw error;
    }
  }
}
